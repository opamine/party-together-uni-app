...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    B: $props.disabled || $props.type === "select",
    C: $options.inputMaxlength,
    D: $props.focus,
    E: $props.confirmType,
    F: $options.getCursorSpacing,
    G: $options.uSelectionEnd,
    H: $options.uSelectionStart,
    I: $props.showConfirmbar,
    J: $props.adjustPosition,
    ...
    M: common_vendor.o((...args) => $options.handleInput && $options.handleInput(...args)),
    N: common_vendor.o((...args) => $options.onConfirm && $options.onConfirm(...args))
  }, {
    O: $options.clearableCom && $options.valueCom != "" && $data.focused
    ...
    Q: common_vendor.o((...args) => $options.onClear && $options.onClear(...args))
  } : {}, {
    R: $props.passwordIcon && $props.type == "password"
    ...
    W: $props.selectOpen ? 1 : ""
  } : {}, {
    X: $props.border ? 1 : "",
    Y: $data.validateState ? 1 : "",
    Z: $props.padding ? $props.padding : `0 ${$props.border ? 20 : 0}rpx`,
    aa: $props.borderColor,
    ab: $options.inputAlignCom,
    ac: $props.backgroundColor,
    ad: common_vendor.o((...args) => $options.inputClick && $options.inputClick(...args))
  });
}
